  ...
  return (
    <section id="gioi-thieu" style={{ padding: '80px 0', backgroundColor: 'white' }}>
      <div style={{ maxWidth: '1024px', margin: '0 auto', padding: '0 24px', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', gap: '48px' }}>
        <div style={{ flex: 1 }}>
          <img src="/logoteptep.png" alt="Logo Tép Tép" style={{ borderRadius: '16px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', width: '100%', maxWidth: '450px', margin: '0 auto' }} />
        </div>
        <div style={{ flex: 1, textAlign: isMobile ? 'center' : 'left' }}>
          ...
          <p style={{ color: 'var(--mau-text-phu)', marginBottom: '16px' }}>
            ...
            Chúng tôi kết hợp công thức gia truyền với quy trình chế biến và đóng gói theo tiêu chuẩn công nghệ, đảm bảo mỗi sản phẩm đến tay bạn đều thơm ngon, sạch sẽ và tiện lợi.
          </p>
          <p style={{ color: 'var(--mau-text-phu)' }}>
            Linh vật của chúng tôi - chú tép robot, đại diện cho sự giao thoa giữa hương vị truyền thống và tinh thần hiện đại, sáng tạo.
          </p>
        </div>
      </div>
    </section>
